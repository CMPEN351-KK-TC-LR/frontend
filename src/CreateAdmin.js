        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/api/users/register', {
                ...
                body: JSON.stringify({
                    ...
                    requesterIsAdmin: true, // User is set to admin by another admin
                }),
            });
            ...
            console.log("Admin created", data); // Log the response data for now
            ...
            {({ handleSubmit, handleChange, values, errors }) => (
                ...
                <Form noValidate onSubmit={handleSubmit} className="min-vh-100 d-flex flex-column">
                    <Container className='w-25'>
                        ...
                        {/* Register button */}
                        <Button size='lg' type="submit">Create Admin</Button>
                    </Container>
                </Form>
            )}
        </Formik>
